...
export default class OrderPage extends Component {
    ...
    async getGame() {
        ...
        console.log(order)
        axios.post("https://amadas.herokuapp.com/orders", order).then(async res=>{
            if (res.data.status === true) {
               axios.get("https://amadas.herokuapp.com/librarys/" + await sessionStorage.getItem("id")).then(res=>{
                    sessionStorage.setItem("library", JSON.stringify(res.data[0].games))
