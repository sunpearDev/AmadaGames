...
router.delete('/:id', (req, res) => {
  Game.find(req.params.id).then( game =>{
    GameType.findByIdAndUpdate({_id:{$in:game.idType}},{games:{$pull:game._id}})
  })
    .catch((err) => res.status(404).json(err))
})
